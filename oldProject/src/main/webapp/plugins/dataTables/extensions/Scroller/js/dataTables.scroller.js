...
var Scroller = function ( dt, opts ) {
	...
	if ( ! (this instanceof Scroller) ) {
		console.warn( "Scroller warning: Scroller must be initialised with the 'new' keyword." );
		return;
	}
...
{
	console.warn( "Warning: Scroller requires DataTables 1.10.0 or greater - www.datatables.net/download");
}
