...
var FixedColumns = function ( dt, init ) {
	...
	if ( ! ( this instanceof FixedColumns ) ) {
		console.warn( "FixedColumns warning: FixedColumns must be initialised with the 'new' keyword." );
		return;
	}
...
$.extend( FixedColumns.prototype , {
	...
	"_fnConstruct": function ( oInit )
	{
		...
		{
			console.warn( "FixedColumns "+FixedColumns.VERSION+" required DataTables 1.8.0 or later. "+ "Please upgrade your DataTables installation" );
			return;
		}
